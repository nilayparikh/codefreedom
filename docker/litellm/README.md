...
Deployed via `docker compose` (see `src/codefreedom/examples/proxy/docker-compose.yaml`). Managed through the CLI:
...
| `LITELLM_CONFIG` | *(empty)* | Path to LiteLLM config file |
