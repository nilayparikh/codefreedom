...
V4-Pro follows the same structure with `deepseek/deepseek-v4-pro` and higher pricing. Add it as a second entry in the same file.

## Enabling

1. Uncomment the model entries in `deepseek.yaml`.
