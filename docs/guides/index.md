---
title: Guides
description: How to use CodeFreedom day-to-day — profiles, sandbox, browser tools, VS Code, and admin.
hide:
  - toc
---
...
Everything you need to use CodeFreedom day-to-day. The pages here assume the proxy is running and you've completed [First run](../getting-started/first-run.md).
