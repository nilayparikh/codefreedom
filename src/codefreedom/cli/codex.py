...
def _generate_codex_config(
    ...
    """Generate codex config.toml pointing at the proxy.

    Returns config_content. No model catalog needed — Codex built-in models
    (gpt-5.5, gpt-5.4, etc.) are aliased in the proxy to custom models.
    Use ``codex -m <model>`` for additional custom models.
    """
