...
This tool runs plain headless Google Chrome for browser automation. For
stealth / anti-bot / headed browsing, use the 'web' tool (Camoufox MCP)
instead — see `codefreedom tools web`.
